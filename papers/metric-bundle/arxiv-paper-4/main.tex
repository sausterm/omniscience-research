...
\subsection{\texorpdfstring{$\SU(4)^3$}{SU(4)³} anomaly}
...
\begin{proof}
The cubic anomaly coefficient for a representation $R$ of $\SU(N)$ is
\[
A(R) = \frac{\Tr_R[T^a \{T^b, T^c\}]}{d^{abc}_{\mathrm{fund}}}\,,
\]
normalised so that $A(\mathrm{fund}) = 1$.
...
\subsection{\texorpdfstring{$\SU(2)_L^3$}{SU(2)L³} and \texorpdfstring{$\SU(2)_R^3$}{SU(2)R³} anomalies}
...
% ============================================================
\section{Witten's \texorpdfstring{$\SU(2)$}{SU(2)} Global Anomaly}
...
\subsection{\texorpdfstring{$\SU(3)_c^3$}{SU(3)c³}}
...
\subsection{\texorpdfstring{$\SU(2)_L^3$}{SU(2)L³}}

Vanishes identically ($d^{abc} = 0$ for $\SU(2)$). $\checkmark$

\subsection{\texorpdfstring{$\SU(3)_c^2$-$\U(1)_Y$}{SU(3)c²-U(1)Y}}
...
\subsection{\texorpdfstring{$\SU(2)_L^2$-$\U(1)_Y$}{SU(2)L²-U(1)Y}}
...
\subsection{\texorpdfstring{$\U(1)_Y^3$}{U(1)Y³}}
...
\subsection{\texorpdfstring{$\U(1)_Y$}{U(1)Y}-grav\texorpdfstring{$^2$}{²} (mixed gravitational)}
...
\subsection{The index theorem on \texorpdfstring{$Y^{14}$}{Y14}}
...
\item Paper~VI \cite{Paper6} derives quantum mechanics---Born rule, interference, uncertainty---from $(6,4)$ DeWitt geometry, deepening the theory's quantum consistency.
\end{enumerate}
